...
const MOCK_MESSAGES = [
  ...
  { id: 2, text: "I'm great! Just working on the new project", sender: 'me', time: '10:32 AM' },
  { id: 3, text: 'That sounds exciting! Tell me more about it', sender: 'other', time: '10:33 AM' },
  { id: 4, text: "It's a social media app with video calls and reels", sender: 'me', time: '10:35 AM' },
];
    ...
    <div className="h-screen flex bg-background">
      ...
      <div className="w-80 border-r border-border flex flex-col">
        ...
        <div className="p-4 border-t border-border">
          <Button variant="primary" className="w-full" onClick={() => navigate('/reels')}>
